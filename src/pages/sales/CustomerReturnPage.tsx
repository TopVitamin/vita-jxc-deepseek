...
export default function CustomerReturnPage() {
  ...
  const openCreate = () => { reset({ returnNo: '', customerName: '', warehouseName: '', returnDate: '', quantity: 0, totalAmount: 0, reason: '', remark: '' }); setDialogOpen(true) }
  ...
  return (
    <div>
      <PageHeader title="销售退货" description="管理客户退货单，记录退货原因和退回商品信息">
      ...
      <SearchPanel onSearch={onSearch} onReset={onReset}>
        <div className="flex items-center gap-1.5"><label className="text-xs text-gray-500 whitespace-nowrap">关键词</label><input value={keyword} onChange={e => setKeyword(e.target.value)} placeholder="退货单号/客户" className="px-3 py-2 border border-gray-300 rounded-md text-sm w-48 focus:outline-none focus:ring-1 focus:ring-primary-500" /></div>
